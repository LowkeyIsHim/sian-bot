...
GAMES_TEXT = (
    ...
    "*/rps*\n"
    "_rock-paper-scissors - reply to challenge_\n\n"
    "*/trivia*\n"
    "_random multiple-choice question, first correct answer wins_\n\n"
    "*/startwcg* `[word]`\n"
    "_word chain game - each word starts with the last letter of the one before_\n"
    "*/endwcg* to stop\n\n"
    "*/hangman*\n"
    "_classic word guessing - anyone can guess a letter_\n"
    "*/endhangman* to stop (admins only)\n\n"
    "*/leaderboard*\n"
    "_see who's winning_\n\n"
    "open to everyone."
)
